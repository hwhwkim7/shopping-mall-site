...
if (target != null && target.length() != 0) {
	response.sendRedirect("/termproject/h/product/itemList_member.jsp?target="+target+"&keyword="+keyword);
}
...
%>
    ...
    <div class="button2"><input type="image" name="sendbtn" src="image/empty.png" width="100" height="30" onclick="cartDelete1(form)"/></div>
